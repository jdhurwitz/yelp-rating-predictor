...
class Train:
    ...
    def __init__(self, model, optimizer, dictionary, config, best_acc):
        ...
        if self.config.class_weight:
            ...
            if self.config.cuda and torch.cuda.is_available(): #unsure if necessary bc of criterion cuda call
    ...
    def train(self, train_corpus):
        ...
        for batch_no in range(1, num_batches + 1):
            ...
            if self.config.pos:
                score = self.model(train_sentences1, sent_len1, train_sentences2, sent_len2, pos_sentences1, pos_sentences2)
            else:
